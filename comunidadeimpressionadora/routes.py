...
def login():
    ...
    if form_criarconta.validate_on_submit() and 'botao_submit_criarconta' in request.form:
        # cripitagrafando senha do usuario
        senha_cript = bcrypt.generate_password_hash(form_criarconta.senha.data)
        # criando usuário e salvando no banco de dados
...
def salvar_imagem(imagem):
    # adicionar um nome aleatorio na imagem
...
def editar_perfil():
    ...
    if form.validate_on_submit():
        ...
        print('teste')
        form.curso_excel.data = marcar_caixa('Excel Impressionador')
        form.curso_vba.data = marcar_caixa('VBA Impressionador')
        form.curso_powerbi.data = marcar_caixa('Power BI Impressionador')
        form.curso_python.data = marcar_caixa('Python Impressionador')
        form.curso_ppt.data = marcar_caixa('Apresentações Impressionadoras')
        form.curso_sql.data = marcar_caixa('SQL Impressionador')
